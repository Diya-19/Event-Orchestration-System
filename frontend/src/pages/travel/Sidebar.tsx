...
import { LayoutDashboard, Bell, MessageCircle, LogOut, Plane, ChevronDown } from "lucide-react";
...
const NAV = [
  ...
  { to: "/travel/queries", label: "Travel Queries", icon: <MessageCircle size={18} /> },
];
  ...
  return (
    <div className="flex h-screen bg-[#faf8fc]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header Wrapper - Clips any overflow/borders */}
        <div className="relative z-20 bg-[#faf8fc]" style={{ lineHeight: 0 }}>
          <header className="h-16 bg-white px-8 flex items-center justify-between">
        ...
        {/* Page Content */}
        <main className="flex-1 overflow-y-auto p-8 bg-[#faf8fc]">
          <Outlet />
        </main>
      </div>
    </div>
